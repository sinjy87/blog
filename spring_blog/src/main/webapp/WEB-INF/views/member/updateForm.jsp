...
<input type = "hidden" name = "nowPage" value = "${param.nowPage}">
  <TABLE>
	...
	<TR>
      <TH>*이메일</TH>
      <TD>
      <input type="text" name = "email" size = "20" value="${dto.email}" onkeydown="emailCheck2(this)">
	...
	<TR>
      <TH>주소</TH>
      <TD><input type="text" name = "address1" size = "40" id="sample6_address" placeholder="주소" value ="${dto.address1}">
