...
<table border="0" cellspacing="0" cellpadding="2"  align="center"> 
    <tr>  
        <td align="center"> 
            <textarea cols="100" rows="20" disabled>Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
...
<div style="text-align: center"> 
  <label for="agreement"><input id = "agreement" type="checkbox" name="agree" value="1" > 약관에 동의합니다</input></label> 
